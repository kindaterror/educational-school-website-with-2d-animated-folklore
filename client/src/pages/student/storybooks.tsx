    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-brand-navy-50 to-ilaw-white">
      ...
      <main className="flex-grow p-4 md:p-8">
        <div className="container mx-auto max-w-6xl">
          {/* Hero Section */}
          <div className="bg-gradient-to-r from-ilaw-gold to-brand-amber rounded-2xl p-8 mb-8 text-ilaw-navy shadow-ilaw">
          ...
          <div className="bg-ilaw-white rounded-2xl shadow-lg border-2 border-brand-gold-200 p-8">
            ...
            <div className="bg-gradient-to-br from-brand-gold-50 to-ilaw-white p-6 rounded-xl border border-brand-gold-200 mb-8">
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="flex-2">
                  <label className="block text-sm font-semibold text-brand-gold-600 mb-2">Search Stories</label>
                  <div className="relative">
            ...
            {isLoading && (
              <div className="text-center py-12">
                ...
                <p className="text-brand-gold-600 font-medium">Loading magical stories...</p>
              </div>
            )}
                  ...
                  <Link key={book.id} href={`/student/storybooks/${book.id}`}>
                    <div className="group flex flex-col items-center p-6 bg-gradient-to-br from-ilaw-white to-brand-gold-50 rounded-xl border-2 border-brand-gold-200 hover:border-ilaw-gold hover:shadow-ilaw transition-all duration-300 cursor-pointer hover:scale-105">
                      {book.coverImage ? (
                        ...
                        <div className="w-40 h-40 flex items-center justify-center bg-gradient-to-br from-ilaw-gold to-brand-amber rounded-lg mb-6 group-hover:scale-110 transition-transform duration-300 shadow-ilaw">
            ...
            {!isLoading && !error && books.length === 0 && (
              <div className="text-center py-16">
                ...
                <h4 className="text-2xl font-heading font-bold text-brand-gold-600 mb-4">No Stories Found</h4>
