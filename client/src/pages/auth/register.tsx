    ...
    try {
      ...
      if (result.user.role === "admin") {
        ...
        toast({
          ...
          description: "Your teacher account is pending approval. You'll be notified when your account is approved.",
        });
        navigate("/login");
      } else {
        navigate("/student");
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      {field.value === "admin" ? "Admin accounts require approval from school administration." :
                       field.value === "teacher" ? "Teacher accounts require approval from administration." :
                       "Student accounts can access learning materials."}
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
