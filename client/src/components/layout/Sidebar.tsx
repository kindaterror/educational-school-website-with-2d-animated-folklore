...
export function Sidebar({ variant = "visitor" }: SidebarProps) {
  ...
  const renderAdminLinks = () => (
    <>
      ...
      <li>
        <a className="flex items-center px-4 py-2 rounded-lg mx-2 hover:bg-ilaw-white hover:shadow-sm cursor-pointer transition-all duration-200">
          <Settings className="w-5 h-5 mr-3 text-ilaw-navy" />
          <span className="font-medium text-ilaw-gray">Account Settings</span>
        </a>
      </li>
      <li>
  ...
  const renderStudentLinks = () => (
    <>
      ...
      <li>
        <a className="flex items-center px-4 py-2 rounded-lg mx-2 hover:bg-ilaw-white hover:shadow-sm cursor-pointer transition-all duration-200">
          <Settings className="w-5 h-5 mr-3 text-ilaw-navy" />
          <span className="font-medium text-ilaw-gray">Settings</span>
        </a>
      </li>
      <li>
        <a onClick={handleLogout} className="flex items-center px-4 py-2 rounded-lg mx-2 hover:bg-red-50 text-red-600 cursor-pointer transition-all duration-200">
  ...
  return (
    <>
      <Sheet open={open} onOpenChange={setOpen}>
        ...
        <SheetContent side="left" className="p-0 w-64 bg-gradient-to-b from-ilaw-white to-brand-gold-50">
